...
* 行内代码使用`1对顿号` 如： \`hello world!\`
* 块级代码使用`3个顿号`或`4个空格`，且上下均用`整行隔开`，如下:  (**占用7行**)
...
#### 参考
[MarkDown 官方语法](https://http://daringfireball.net/projects/markdown/)
[GitHub MakDown 语法](https://https://github.com/mojombo/github-flavored-markdown/issues/1)
