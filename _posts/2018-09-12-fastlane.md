...
![fastlane_init](/../assets/images/post/2018-09-11-15366328908637.jpg)

fastlane提供了几种默认的配置，可以根据实际需求选择，期间可能会要求输入一些配置信息，根据提示输入即可。

根据你选择的配置，会生成不同的配置文件。

![fastlane_file](/../assets/images/post/2018-09-11-15366335231432.jpg)
...
![sighRecording](/../assets/images/post/2018-09-11-sighRecording.gif)
...
![PEMRecording](/../assets/images/post/2018-09-12-PEMRecording.gif)
