---
layout: post
title: Objective-C Coding Guideline
...
*	[Github](https://github.com/Zrocky/iOS-Coding-Guideline)
...
这里整合的代码规范主要总结了以上两文, 加上本人在工作中的总结和经验, 整理出适合我们公司的代码规范.
...
尽管很多时候能用`new`代替`alloc init`方法，但这可能会导致调试内存时出现不可预料的问题。Cocoa的规范就是使用`alloc init`方法，使用`new`会让一些人困惑。
